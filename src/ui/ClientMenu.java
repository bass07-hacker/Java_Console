...
/**
 * Interface utilisateur pour la gestion des clients avec design premium.
 */
public class ClientMenu {
    ...
    /**
     * Formulaire d'ajout de client premium.
     */
    public void showAddClient() {
        ...
        try {
            clientService.addClient(nom, prenom, tel);
    ...
    /**
     * Affiche la liste des clients avec design premium.
     */
    public void showListClients() {
        ...
        if (clients.isEmpty()) {
            ...
            System.out.println(ConsoleUI.BOLD_GREEN + String.format("%-5s | %-15s | %-15s | %-12s", "ID", "NOM", "PRÉNOM", "TÉLÉPHONE") + ConsoleUI.RESET);
